...
void CanInterface::SetSendFunction(SendFunctionType sendFunction)
{
    _sendFunction = sendFunction;
}

void CanInterface::SetReceiveFunction(ReceiveFunctionType receiveFunction)
{
    _receiveFunction = receiveFunction;
}

void CanInterface::SetTimeoutFunction(SetTimeoutFunctionType setTimeoutFunction)
{
...
void CanInterface::SetTimeout(uint32_t timeout)
{
